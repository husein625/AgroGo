...
export class PlantListComponent implements OnInit {
  ...
  searchText: any;
    ...
    products=[
      new Product( "Allium melanantherum","assets/allium_melanantherum.jpg","Prenj, Čvrsnica, Čabulja", "Allium melanantherum is a species of plant in the amaryllis family and is native to Bulgaria, Greece, Montenegro, Slovenia, Bosnia and Herzegovina, Serbia, North Macedonia and Croatia."),
      new Product("Asperula hercegovina", "assets/Minuartia handelii.jpg", "Bosnian stenoendem", " This  species is a perennial herb. It tends to reach about 10–20 cm tall and can be smooth or hairy. Its leaves occur in apparent whorls, with a rough length of 13–25 cm and a width of about 1.5–2 (rarely 3) mm wide. Leaves are linear lancet, smooth or hairy, with rough edges and are longer than internodia. They have 6–12 involucral ballots that are 4–5 mm long and 2–4 mm wide. The shape of their lanceolate is egg-shaped or oval."),
      new Product("Asperula purpurea", "assets/Asperula purpurea.jpg", "Endemic South East Dinars", "Asperula purpurea is a species of flowering plant in the family Rubiaceae. It was first described in 1974 and is endemic to France, Switzerland, Italy, Austria, Slovenia, Serbia, Bosnia and Herzegovina, Montenegro, Croatia, Romania, Albania, Greece, and Turkey."),
      new Product("Asperula taurina", "assets/Asperula taurina.jpg", "Banja Luka, Jahorina", "Asperula taurina is a species of flowering plant in the family Rubiaceae. It was first described in 1753 and is endemic to Albania, Austria, Bulgaria, France, Greece, Hungary, Iran, Italy, Crimea, Romania, Switzerland, Georgia, Armenia, Azerbaijan, Turkey, Sloevnia, Croatia, Bosnia, Serbia, and Montenegro. It was also introduced to Denmark, Germany, and Great Britain."),
      new Product("Astrantia carniolica", "assets/Astrantia carniolica.jpg", "Maglić", "Astrantia carniolica, the carnic masterwort or red masterwort, is a species of flowering plant in the family Apiaceae. It has long reddish (or white) flowers."),
      new Product("Campanula hercegovina", "assets/Campanula hercegovina.jpg", "Canyons of Neretva and Drežnica rivers", "Campanula hercegovina, the Herzegovinian bellflower, is an endemic plant from Bosnia and Herzegovina. It belongs to the Campanulaceae, or bellflower, family."),
      new Product("Carex brachystachys", "assets/Carex brachystachys.jpg", "Šar Mountain", "Carex brachystachys is a species of sedge found in the mountains of central and southern Europe."),
      new Product("Carob", "assets/Carob.jpg", "Čapljina", "The carob (Ceratonia siliqua) is a flowering evergreen tree or shrub in the legume family, Fabaceae. It is widely cultivated for its edible pods, and as an ornamental tree in gardens and landscapes. The carob tree is native to the Mediterranean region and the Middle East.[1][2] Portugal is the largest producer of carob, followed by Italy and Morocco. In the Mediterranean Basin, including the southern Atlantic coast of Portugal (i.e. the Algarve region) and the northwestern Moroccocan coast, carob pods were often used as animal feed and in times of famine, as  the last source of [human] food in hard times .[3] The ripe, dried, and sometimes toasted pod is often ground into carob powder, which was sometimes used as an ersatz cocoa powder, especially in the 1970s natural food movement.[4] However, through a change in consumer tastes as well as refined industrial technology and other improved commodity processing methods in the early 21st century, carob-based products became a substitute good or an alternative to chocolate, firstly for people with digestive or dietary issues, and later to a wider range of consumers."),
  ...
  Send(){
   ...
   const example = "ss";
      this.router.navigate(['../graphs', example], navigationExtras);
  }
